...
class OrderTracker2 extends StatefulWidget {
  ...
  @override
  State<OrderTracker2> createState() => _OrderTracker2State();
}

class _OrderTracker2State extends State<OrderTracker2>
  ...
  @override
  void initState() {
    if (widget.status?.name == Status2.one.name) {
    ...
    } else if (widget.status?.name == Status2.two.name) {
      ///initialize first controller
      controller = AnimationController(
        vsync: this,
        duration: const Duration(seconds: 1),
    ...
    } else if (widget.status?.name == Status2.three.name ||
        widget.status?.name == Status2.four.name) {
      ///initialize first controller
      controller = AnimationController(
        vsync: this,
        duration: const Duration(seconds: 1),
            ...
            Row(
              children: [
                Container(
                  ...
                  width: 15,
                  decoration: BoxDecoration(
                      color: (widget.status?.name == Status2.two.name ||
                                  widget.status?.name == Status2.three.name ||
                                  widget.status?.name == Status2.four.name) &&
                              isFirst == true
            ...
            Row(
              children: [
                Container(
                  ...
                  width: 15,
                  decoration: BoxDecoration(
                      color: (widget.status?.name == Status2.three.name ||
                                  widget.status?.name == Status2.four.name) &&
                              isSecond == true
                          ? widget.activeColor ?? Colors.green
                          : widget.inActiveColor ?? Colors.grey[300],
            ...
            Row(
              children: [
                Container(
                  ...
                  width: 15,
                  decoration: BoxDecoration(
                      color: widget.status?.name == Status2.four.name &&
                              isThird == true
                          ? widget.activeColor ?? Colors.green
                          : widget.inActiveColor ?? Colors.grey[300],
                      borderRadius: BorderRadius.circular(50)),
...
class TextDto2 {
  ...
  TextDto2(this.title, this.date);
}

enum Status2 { one, two, three, four }
